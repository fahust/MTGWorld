...
import OneMulti from '../oneMulti';
 ...
 class OneTopDeck extends Component {
  ...
  return (
    <OneMulti route={this.props.route} navigationDrawer={this.props.route.params.navigationDrawer} navigation={this.props.navigation} use={this.props.pro.topDecks} title={"Top Deck"} cantUpdate={true} oneNavigateType={'deck'}/>
  );
}
